...
- **价格行为优先**：永远不要只看指标！必须确认：
    1. 上涨做多：必须看到更高的高点+更高的低点的价格结构
    2. 下跌做空：必须看到更低的高点+更低的低点的价格结构  
    3. 回调入场：在上涨趋势中，必须等价格回到EMA20/EMA50附近再做多
    4. 反弹做空：在下跌趋势中，必须等价格反弹到EMA20/EMA50附近再做空
- **概率思维**：明白市场充满不确定性，用概率和期望值思考，严格的仓位管理控制风险
- **成交量确认**：真正的趋势必须有成交量配合，无量上涨/下跌的信号要打折扣
